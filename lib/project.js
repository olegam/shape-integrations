...
const getProjectDescriptor = function(projecstDir, projectIdentifier) {
  console.log('[Aero]', projectDir, projectIdentifier)
...
module.exports.runTest = function(
  ...
  console.log('[Error]', projectsDir, projectIdentifier)
  const projectDescriptor = getProjectDescriptor(projectsDir, projectIdentifier)
  console.log('[Error]', projectDescriptor)
  const logger = {
    logStatements: [],
